...
names.splice(2, 0, '김가윤', '박경아'); //'박소현', '오지민', '김가윤', '박경아', '이희수', '인은지'
names.splice(1, 2, '김가윤', '박경아'); //'박소현', '김가윤', '박경아', '박경아', '이희수', '인은지'
names.splice(4, 0, '김가윤', '박경아'); //'박소현', '김가윤', '박경아', '박경아', '김가윤', '박경아', '이희수', '인은지'
